...
export function getTextFactura(transaccion:Transaccion, cliente:string, libro:string){
    const factura:string = `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
                    ...
                    <hr />
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4>Guatemala, ${new Date().toUTCString()}</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td class=" text-right ">${transaccion.valorUnitario.toFixed(2)}</td>
                    <td class=" text-right ">${transaccion.valorFinal.toFixed(2)}</td>
                ...
                <tr >
                    ...
                    <td style="text-align: right;"><a href="#" > ${transaccion.valorFinal.toFixed(2)} </a></td>
